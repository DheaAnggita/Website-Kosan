	...
	<div class="row">
		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="form-group">
				...
				<input type="text" name="nomorkamar" id="nomorkamar" class="form-control" placeholder="Nomor Kamar" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="file" name="foto" id="foto" class="form-control" placeholder="Foto Kamar" required>
			</div>
