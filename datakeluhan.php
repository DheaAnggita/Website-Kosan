            ...
            <div class="information">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php include "fungsi.php";
                        $query = mysqli_query($conn, "SELECT * FROM keluhanpa1 INNER JOIN kamarpa1 ON keluhanpa1.idkamar = kamarpa1.idkamar INNER JOIN user ON keluhanpa1.iduser = user.id");
