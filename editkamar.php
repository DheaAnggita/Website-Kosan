...
<div id="content" class="p-5 p-md-5 pt-5">
	<div class="row">
        ...
        <?php
            ...
            $db = mysqli_query($conn," SELECT * FROM kamarpa1 WHERE idkamar='$idkamar'");
		...
		?> 
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select name="status" value="<?php echo $hasil['status']?>">
					...
					<div class="form-group">
						...
						<input type="file" name="foto" id="foto" class="form-control" placeholder="Foto Kamar" >
					</div>
